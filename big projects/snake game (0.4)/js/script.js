...
let gameOver = function () {
	...
	mySound = new sound("sound/gameover.mp3");
...
function startGame(){
mySound = new sound("sound/start.wav");
	mySound.play();  //   can put it in different places of the soft
	if(intervalTimer == 0){
    ...
    let goodSound = new sound("sound/theme.mp3");
	goodSound.play();
	
    themeIntervalId = setInterval(function() {	
	let theSound = new themeSound("sound/theme.mp3");
	theSound.play();
}, 180000);
}
